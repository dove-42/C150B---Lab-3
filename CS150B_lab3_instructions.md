...
```
Lets break it down!
- The word **boxes** and **storage** are the variables in the code. Variables can be named whatever you like, however naming it related to what your doing can help keep track of what your code is doing! Plus, adding special characters like !, #, or & will create error called **NameError**, as these arent allowed when making a name due to its ambiguity.
- The equal sign **=** is what connects the variable. Without this, a variable wont be created and wont have anything in it!
- The **"bunch of data and stuff"** and **"4"** is what is being stored in the variables! This means whenever we type **boxes** or **storage**, it will instead output whatever is on the right side of the variable!
- In the print, the variables **boxes** and **storage** dont have quotes. The reason is because it allows us to connect back to the variable we created! If it was surrounded by quotes, it will only produce the word "boxes" and not actually what is inside **boxes**, which in this example is **"bunch of data and stuff"**.
...
1) Figure what is missing in the print statement that's causing the error!
...
Yer a Wizard Harry!
```
4) Figure what is missing for the variable that's causing the error!
...
**NOTE:** Hard coding is the practice of embedding specifc data without actually grabbing it. If you type this line in without variables, you won't get points!
